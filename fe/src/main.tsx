  ...
  Auth: {
    Cognito: {
      loginWith: {
        ...
        email: true,
        oauth: {
          redirectSignIn: ["https://mymuse.in", "mymuseapp://auth"],
          redirectSignOut: ["https://mymuse.in", "mymuseapp://auth"],
          domain: "auth-dev-mymuseapp.auth.ap-south-1.amazoncognito.com",
          providers: ["Google"],
          scopes: ["email", "openid"],
          responseType: "code",
        },
